  ...
  return (
    <nav className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        {/* Logo */}
        <div className="flex items-center gap-[9px] w-[176px] h-[41px]">
          <img
            src="https://propbot-real-estate-app.netlify.app/logo.png"
            alt="logo"
            className="w-[32px] h-[32px]" // adjust if Figma icon size differs
          />
          <span className="font-poppins font-bold text-[24px] leading-[24px] tracking-[0] text-gray-800">
            PropBot
          </span>
        </div>
        ...
        <ul className="hidden md:flex gap-8 text-gray-600 font-small relative">
          {links.map((link) => (
            <li
              key={link.name}
              className="relative font-poppins text-[18px] leading-[100%] text-center"
            >
              <Link
                to={link.path}
        ...
        {user ? (
          <button
            ...
            className="hidden md:flex items-center justify-center gap-1 w-[208px] h-[47px] bg-red-600 text-white px-5 py-2.5 rounded-[24px] hover:bg-red-700 transition font-poppins font-normal text-[16px] leading-[18px] tracking-normal text-center"
          >
          ...
          <Link
            to="/register"
            className="hidden md:flex items-center justify-center gap-1 w-[208px] h-[47px] bg-blue-800 text-white px-5 py-2.5 rounded-[24px] hover:bg-blue-900 transition font-poppins font-normal text-[18px] leading-[18px] tracking-normal text-center"
          >
            Login / Register
